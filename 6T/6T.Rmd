...
there are currently 100 protease structures.
...
in this structure?
the hydrogens are hidden because there are too many of them to make visualization feasible if they were not hidden.
...
Q5: As you have hopefully observed HIV protease is a homodimer (i.e. it is composed of two
identical chains). With the aid of the graphic display and the sequence viewer extension can you
identify secondary structure elements that are likely to only form in the dimer rather than the
monomer?
TODO
